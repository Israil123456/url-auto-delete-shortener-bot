...
PICS = (environ.get('PICS', 'https://envs.sh/S9-.jpg')).split()
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001948358628').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001902019959')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001985688722')).split()]
